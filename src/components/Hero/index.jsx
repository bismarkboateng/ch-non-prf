  ...
  return (
    <div className="w-full mt-5 relative">
      <img
        src={Hero}
        alt="hero"
        className="w-full h-[300px] object-cover md:h-[723px] animate-slideRight"
      />
      ...
      >
        <div data-aos="fade" data-aos-delay="2000" 
          ...
          text-base md:text-xl leading-7 md:mb-2">
          Give Hope For Homeless
        </div>
        
        <div data-aos="fade" data-aos-delay="2600"
          className="font-playfair mt-2 font-semibold text-[18px] 
        ...
        <div data-aos="fade" data-aos-delay="2900"
          className="font-montserrat text-[15px] leading-[19px]
        ...
        <div data-aos="fade" data-aos-delay="3000"
          className="flex flex-row gap-5 ml-[10%] md:gap-8 md:ml-[20%]
          lg:ml-[31.5%]">
          <Button
